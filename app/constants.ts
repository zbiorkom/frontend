import { CityCategory, VehicleType } from "./typings";

export const cityCategoryOrder: CityCategory[] = [
    CityCategory.LowerSilesian,
    CityCategory.KuyavianPomeranian,
    CityCategory.Lodz,
    CityCategory.Lublin,
    CityCategory.Lubusz,
    CityCategory.LesserPoland,
    CityCategory.Masovian,
    CityCategory.Opole,
    CityCategory.Subcarpathian,
    CityCategory.Podlasie,
    CityCategory.Pomeranian,
    CityCategory.Silesian,
    CityCategory.HolyCross,
    CityCategory.WarmianMasurian,
    CityCategory.GreaterPoland,
    CityCategory.WestPomeranian,
    CityCategory.Finland,
    CityCategory.Sweden,
    CityCategory.Netherlands,
    CityCategory.Virtual,
];

export const cityCategoryEmojis: Record<CityCategory, string> = {
    [CityCategory.LowerSilesian]: "🏰",
    [CityCategory.KuyavianPomeranian]: "🍪",
    [CityCategory.Lodz]: "🎬",
    [CityCategory.Lublin]: "🌻",
    [CityCategory.Lubusz]: "🍇",
    [CityCategory.LesserPoland]: "⛰️",
    [CityCategory.Masovian]: "🪺",
    [CityCategory.Opole]: "🎵",
    [CityCategory.Subcarpathian]: "🐻",
    [CityCategory.Podlasie]: "🦬",
    [CityCategory.Pomeranian]: "🌊",
    [CityCategory.Silesian]: "⛏️",
    [CityCategory.HolyCross]: "✝️",
    [CityCategory.WarmianMasurian]: "🏞️",
    [CityCategory.GreaterPoland]: "🐐",
    [CityCategory.WestPomeranian]: "🗼",
    [CityCategory.Finland]: "🦌",
    [CityCategory.Sweden]: "🌲",
...
export const cityCategoryI18nKeys: Record<CityCategory, string> = {
    [CityCategory.LowerSilesian]: "cityCategory.lowerSilesian",
    [CityCategory.KuyavianPomeranian]: "cityCategory.kuyavianPomeranian",
    [CityCategory.Lodz]: "cityCategory.lodz",
    [CityCategory.Lublin]: "cityCategory.lublin",
    [CityCategory.Lubusz]: "cityCategory.lubusz",
    [CityCategory.LesserPoland]: "cityCategory.lesserPoland",
    [CityCategory.Masovian]: "cityCategory.masovian",
    [CityCategory.Opole]: "cityCategory.opole",
    [CityCategory.Subcarpathian]: "cityCategory.subcarpathian",
    [CityCategory.Podlasie]: "cityCategory.podlasie",
    [CityCategory.Pomeranian]: "cityCategory.pomeranian",
    [CityCategory.Silesian]: "cityCategory.silesian",
    [CityCategory.HolyCross]: "cityCategory.holyCross",
    [CityCategory.WarmianMasurian]: "cityCategory.warmianMasurian",
    [CityCategory.GreaterPoland]: "cityCategory.greaterPoland",
    [CityCategory.WestPomeranian]: "cityCategory.westPomeranian",
    [CityCategory.Finland]: "cityCategory.finland",
    [CityCategory.Sweden]: "cityCategory.sweden",
    [CityCategory.Netherlands]: "cityCategory.netherlands",
    [CityCategory.Virtual]: "cityCategory.virtual",
};

export const vehicleTypeI18nKeys: Record<number, string> = {
    ...
    [VehicleType.Ferry]: "vehicleType.ferry",
    [VehicleType.CableTram]: "vehicleType.cableTram",
    [VehicleType.AerialLift]: "vehicleType.aerialLift",
    [VehicleType.Funicular]: "vehicleType.funicular",
    [VehicleType.Trolleybus]: "vehicleType.trolleybus",
    [VehicleType.Monorail]: "vehicleType.monorail",
};
...
export const typeIcons: Record<number, string> = {
